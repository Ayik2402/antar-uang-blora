        ...
        <header class="header navbar navbar-expand-sm" style="background: #043BA0 !important;">
            ...
            <ul class="navbar-item theme-brand flex-row  text-center">
                ...
                <li class="nav-item theme-text">
                    <a href="/home" class="nav-link" style="color: white !important;"> Selamat datang admin </a>
    ...
    {{-- <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
        ...
        <!-- Topbar Search -->
        <div class="p-3">
            <h5><a href="/home" class="nav-link" style="color: black !important; font-weight: bold"> Selamat datang admin {{Auth::user()->name}} </a></h5>
    </div>
