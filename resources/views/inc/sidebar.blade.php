...
<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu">
                <a href="#components123" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);">
                ...
                <ul class="collapse submenu list-unstyled" id="components123" data-parent="#accordionExample">
                    <li><a style="margin-left: 0px !important;" href="/biaya-transfer">Biaya Transfer</a></li>
                    <li><a style="margin-left: 0px !important;" href="/daftar-bank">Daftar Bank</a></li>
                    <li><a style="margin-left: 0px !important;" href="/jenis-tabungan">Jenis Tabungan</a></li>
                    <!-- <li><a style="margin-left: 0px !important;" href="/daftar-rekening">Rekening bank</a></li> -->
                </ul>
            </li>
            <li class="menu">
                <a href="/register-nasabah" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);">
                            <path d="M13 9h-3v2h3a1 1 0 0 0 0-2z"></path>
                            <path d="M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2zm2.13 15-2.67-4H10v4H8V7h5a3 3 0 0 1 .79 5.88L16.54 17z"></path>
                        </svg>
                        <span>Register Nasabah</span>
                    </div>
                </a>
            </li>
            <li class="menu">
            ...
            <li class="menu">
                <a href="/permohonan-rekening-transfer" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);">
                        ...
                        <span>Permohonan <br>
                            <div class="text-center ml-3 mr-1">Rekening</div>
                        </span>
                    </div>
                </a>
            </li>
            ...
            <li class="menu">
                <a href="/data-transfer" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);">
            ...
            <!-- <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="components123" data-parent="#accordionExample">
                    <li><a style="margin-left: 0px !important;" href="/daftar-bank">Bank</a></li>
                    <li><a style="margin-left: 0px !important;" href="/daftar-rekening">Rekening bank</a></li>
                    <li><a style="margin-left: 0px !important;" href="/daftar-pulsa">Pulsa</a></li>
                    <li><a style="margin-left: 0px !important;" href="/token-listrik">Token listrik</a></li>
                </ul>
            </li>
            <li class="menu">
                <a href="#components12" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);">
                ...
                <ul class="collapse submenu list-unstyled" id="components12" data-parent="#accordionExample">
                    <li><a style="margin-left: 0px !important;" href="/daftar-permohonan-transfer">Permohonan transfer</a></li>
                    <li><a style="margin-left: 0px !important;" href="/transaksi-gaji">Permohonan gaji</a></li>
                </ul>
            </li>
            <li class="menu">
                <a href="#components12s" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);">
                ...
                <ul class="collapse submenu list-unstyled" id="components12s" data-parent="#accordionExample">
                    <li><a style="margin-left: 0px !important;" href="/setting-webiste">Website</a></li>
                    <li><a style="margin-left: 0px !important;" href="#">Akun</a></li>
                </ul>
            </li> -->
            ...
            <!-- <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="components123" data-parent="#accordionExample">
                    <li><a href="/home">Report lembar kerja</a></li>
                    <li><a href="#">Report keuangan</a></li>
                </ul>
            </li>

            <li class="menu">
                <a href="/lembar-kerja" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);">
